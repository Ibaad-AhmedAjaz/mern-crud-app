    ...
    <div className='addUser'>
        ...
        <form className='addUserForm' onSubmit={submitForm}>
            ...
            <div className='inputGroup'>
                ...
                <input type="email" id="email" value={user.email} onChange={inputHandler} autoComplete='off'
                placeholder='Enter your Email' name="email"/>
            </div>
            <div className='inputGroup'>
                <label htmlFor="address"> Address:</label>
                <input type="text" id="address" value={user.address} onChange={inputHandler} autoComplete='off'
